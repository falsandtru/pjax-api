...
また、プリロードとクライアントサイドロードバランサによる高速化を利用できます。

## 特徴

* プリロードによる高速化
* クライアントサイドロードバランサによる高速化
...
## Ajax Load Balancing
通常のロードバランサと異なり、ルーターやロードバランサなどのハードウェアを使用せず回線帯域の約30～150%(1.3-2.5倍)の増設・分散効果を得られます。詳細は[Load Balancer](loadbalancer/)をお読みください。
