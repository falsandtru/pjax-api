/*! pjax-api v3.29.6 https://github.com/falsandtru/pjax-api | (c) 2012, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
        ...
        function (_dereq_, module, exports) {
            ...
            class URL {
                constructor(url, base = location.href) {
                    this.url = new global.URL(format_1.formatURLForEdge(url, base), base);
                    Object.freeze(this);
                }
                get reference() {
    ...
    86: [
        function (_dereq_, module, exports) {
            ...
            function normalize(url, base) {
                return new global.URL(formatURLForEdge(url, base), base).href;
            }
