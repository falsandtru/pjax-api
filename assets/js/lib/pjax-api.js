/*! pjax-api v3.6.1 https://github.com/falsandtru/pjax-api | (c) 2016, falsandtru | GPL-2.0 License */
                ...
                return new spica_1.HNil().push(Promise.resolve(cancelable.either(seq))).modify(function (p) {
                    ...
                    return p.then(function (m) {
                        return m.bind(cancelable.either).fmap(function (ps) {
                            return ps[0].then(function (m1) {
                                return ps[1].then(function (m2) {
                                    return ps[2].then(function (m3) {
