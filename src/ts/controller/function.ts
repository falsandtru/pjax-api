...
module MODULE.CONTROLLER {
  ...
  export class Functions implements PJAX.Method<Functions> {
    ...
    click(url?: any, attrs?: { [index: string]: any; }): JQueryPjaxStatic {
      ...
      setting && $anchor.first().one(setting.nss.event.click, (...args) => Controller.singleton().click(args)).click();
      return <any>this;
    }
    ...
    submit(url?: any, attrs?: { [index: string]: any; }, data?: any): JQueryPjaxStatic {
      ...
      setting && $form.first().one(setting.nss.event.submit, (...args) => Controller.singleton().submit(args)).submit();
      return <any>this;
    }
