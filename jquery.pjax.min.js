...
else{d&&d.test(3,1,0,"drive:initialize");var l,j,f,r,x,z,y=[],B={xhr:function(){f=k(a.callbacks.ajax.xhr,h,[b,a.parameter],a.callbacks.async);return f=f instanceof Object&&f instanceof q.XMLHttpRequest?f:f||jQuery.ajaxSettings.xhr()},dataFilter:function(f,e){l=f;j=e;return k(a.callbacks.ajax.dataFilter,h,[b,a.parameter,l,j],a.callbacks.async)||l},complete:function(d,e){f=d;r=e;k(a.callbacks.ajax.complete,h,[b,a.parameter,f,r],a.callbacks.async)}},C;for(C in B)C in a.callbacks.ajax||"xhr"===C||delete B[C];
d&&d.test(4,1,0,"drive:popstate");if("popstate"===b.type.toLowerCase()){if((y=m.match(/\?[^\s]*/))&&"?"!==y[0])a.ajax.type="GET";a.ajax.data=null}d&&d.test(5,1,0,"drive:submit");"submit"===b.type.toLowerCase()&&(m=m.replace(/\?[^\s]*/,""),a.ajax.type=jQuery(b.target).attr("method").toUpperCase(),"GET"===a.ajax.type&&(d&&d.test(5.1,1,jQuery(b.target).serialize(),"drive:serialize"),m+="?"+jQuery(b.target).serialize(),a.ajax.data=null),"POST"===a.ajax.type&&(d&&d.test(5.1,1,jQuery(b.target).serializeArray(),
"drive:serializeArray"),a.ajax.data=jQuery(b.target).serializeArray()));d&&d.test(6,1,0,"drive:url");a.server.query&&(m=m.replace(/(#[^\s]*|)$/,(!m.match(/\?/)?"?":"&")+encodeURIComponent(a.server.query)+"=1$1"));d&&d.test(7,1,0,"drive:ajax");a.speedcheck&&a.log.speed.name.push("ajax_start");a.speedcheck&&a.log.speed.time.push(a.speed.now()-a.log.speed.fire);jQuery.when?jQuery.when(u(a.wait),jQuery.ajax(jQuery.extend(!0,{},a.ajax,B,{url:m,beforeSend:function(d){f=d;f.setRequestHeader(a.nss.requestHeader,
"true");f.setRequestHeader(a.nss.requestHeader+"-Area",a.area);f.setRequestHeader(a.nss.requestHeader+"-CSS",a.load.css);f.setRequestHeader(a.nss.requestHeader+"-Script",a.load.script);k(a.callbacks.ajax.beforeSend,h,[b,a.parameter,f],a.callbacks.async)},success:function(d,e,m){l=d;j=e;f=m;k(a.callbacks.ajax.success,h,[b,a.parameter,l,j,f],a.callbacks.async)},error:function(d,e,c){f=d;r=e;x=c;var g=n[a.id]&&n[a.id].validate?n[a.id].validate.clone({name:"jquery.pjax.js - drive()"}):g;g&&g.start();
g&&g.test("++",1,[m,q.location.href],"ajax_regular()");g&&g.test("++",1,[f,r,x],"ajax error");k(a.callbacks.ajax.error,h,[b,a.parameter,f,r,x],a.callbacks.async);if(a.fallback)return"function"===typeof a.fallback?a.fallback(b):I(b,g);g&&g.end()}}))).done(function(){s()}).fail().always():jQuery.ajax(jQuery.extend(!0,{},a.ajax,B,{url:m,beforeSend:function(d){f=d;f.setRequestHeader(a.nss.requestHeader,"true");f.setRequestHeader(a.nss.requestHeader+"-Area",a.area);f.setRequestHeader(a.nss.requestHeader+
"-CSS",a.load.css);f.setRequestHeader(a.nss.requestHeader+"-Script",a.load.script);k(a.callbacks.ajax.beforeSend,h,[b,a.parameter,f],a.callbacks.async)},success:function(d,e,g){l=d;j=e;f=g;k(a.callbacks.ajax.success,h,[b,a.parameter,l,j,f],a.callbacks.async);s()},error:function(d,e,g){f=d;r=e;x=g;var c=n[a.id]&&n[a.id].validate?n[a.id].validate.clone({name:"jquery.pjax.js - drive()"}):c;c&&c.start();c&&c.test("++",1,[m,q.location.href],"ajax_legacy()");c&&c.test("++",1,[f,r,x],"ajax error");k(a.callbacks.ajax.error,
h,[b,a.parameter,f,r,x],a.callbacks.async);if(a.fallback)return"function"===typeof a.fallback?a.fallback(b):I(b,c);c&&c.end()}}));!1!==k(a.callbacks.after,h,[b,a.parameter],a.callbacks.async)&&(d&&d.test(8,1,0,"drive:end"),d&&d.end())}}function k(a,b,c,g){if("function"===typeof a)return g?setTimeout(function(){a.apply(b,c)},0):a.apply(b,c)}function u(a){var b=jQuery.Deferred();if(!a)return b.resolve();setTimeout(function(){b.resolve()},a);return b.promise()}function I(a,b){b&&b.test("++",1,0,"fallback()");
b&&b.end();"click"===a.type.toLowerCase()?q.location.href=a.currentTarget.href:"submit"===a.type.toLowerCase()?context.submit():"popstate"===a.type.toLowerCase()&&q.location.reload()}function G(a,b){var c=[];a.replace(RegExp(b,"gim"),function(a,h){c.push(h)});return c}function w(a,b,c,g,k,n,d){var l;switch(!0){case a===t||b===t:break;case c===t:a.data[b]&&(new Date).getTime()>a.data[b].timestamp+a.config.expire&&arguments.callee(a,b,null,null);l=a.data[b];break;case null===g:for(var j=0,f;f=a.order[j];j++)b===
f&&(a.order.splice(j,1),a.size-=a.data[f].size,a.data[f]=null,delete a.data[f]);break;default:a.order.unshift(b);for(j=1;f=a.order[j];j++)b===f&&a.order.splice(j,1);if(a.data[b])break;g=g||1.8*k.length;a.size=a.size||0;a.size+=g;a.data[b]={data:null,dataType:n,XMLHttpRequest:d,title:c,size:g,timestamp:(new Date).getTime()};for(j=a.order.length-1;b=a.order[j];j--)if(j>=a.config.length||a.size>a.config.size||(new Date).getTime()>a.data[b].timestamp+a.config.expire)a.order.splice(j,1),a.size=a.size||
0,a.size-=a.data[b].size,a.data[b]=null,delete a.data[b]}return l}function y(a,b,c){var g;switch(!0){case b===t:g=jQuery.falsandtru[a];break;case c===t:g=a in jQuery.falsandtru?jQuery.falsandtru[a][b]:t;break;case c!==t:jQuery.falsandtru[a]instanceof Object||(jQuery.falsandtru[a]={}),jQuery.falsandtru[a][b]instanceof Object&&c instanceof Object?jQuery.extend(!0,jQuery.falsandtru[a][b],c):jQuery.falsandtru[a][b]=c,g=jQuery.falsandtru[a][b]}return g}if("function"===typeof this)return arguments.callee.apply(jQuery(J),
arguments);var s=window.validator instanceof Object?window.validator:!1;(s=s?s.clone({name:"jquery.pjax.js",base:!0,timeout:{limit:z&&z.ajax&&z.ajax.timeout?z.ajax.timeout+s.timeout.limit:s.timeout.limit}}):s)&&s.start();s&&s.test("++",1,0,"pjax()");var a=jQuery.extend(!0,{},{id:0,gns:"pjax",ns:t,area:t,link:'a:not([target])[href^="/"]',form:t,scrollTop:0,scrollLeft:0,ajax:{},contentType:"text/html",cache:{click:!1,submit:!1,popstate:!1,length:9,size:1048576,expire:18E5},callback:function(){},callbacks:{ajax:{},
update:{url:{},title:{},content:{},css:{},script:{},cache:{load:{},save:{}},verify:{}},async:!1},parameter:t,load:{css:!1,script:!1,sync:!0,async:0},interval:300,wait:0,fallback:!0,server:{query:""},speedcheck:!1},z),r=[a.gns].concat(a.ns||[]);jQuery.extend(!0,a,{nss:{pjax:r.join("."),click:["click"].concat(r.join(":")).join("."),submit:["submit"].concat(r.join(":")).join("."),popstate:["popstate"].concat(r.join(":")).join("."),data:r.join(":"),class4html:r.join("-"),requestHeader:["X",r[0].replace(/^\w/,
function(a){return a.toUpperCase()})].join("-"),array:r},server:{query:a.server.query.length?a.server.query:a.gns},log:{script:{},speed:{}},history:{config:a.cache,order:[],data:{}},timestamp:(new Date).getTime(),disable:!1,on:function(){for(var a=1,b=n.length;a<b;a++)n[a].disable=!1},off:function(){for(var a=1,b=n.length;a<b;a++)n[a].disable=!0},landing:q.location.href,validate:s,retry:!0,speed:{now:function(){return(new Date).getTime()}}});jQuery.falsandtru||(jQuery.fn.falsandtru=y,jQuery.falsandtru=
y);jQuery.falsandtru("share","history",a.history);a.history=jQuery.falsandtru("share","history");if(!("pushState"in q.history&&null!==q.history.pushState)?0:jQuery(a.area).length){var c=a;c.id=n.length;n.push(c);c.link&&jQuery(this).undelegate(c.link,c.nss.click).delegate(c.link,c.nss.click,c.id,function(a){a.timeStamp=(new Date).getTime();if(1<a.which||(a.metaKey||a.ctrlKey||a.shiftKey||a.altKey)||(q.location.protocol!==this.protocol||q.location.host!==this.host)||q.location.pathname===this.pathname&&
q.location.search===this.search&&q.location.hash!==this.hash)return this;var b,c,g;b=n[a.data];c=this.href;b.cache[a.type.toLowerCase()]&&(g=w(b.history,c));b.landing&&(b.landing=!1);if(b.disable)return a.preventDefault(),!1;b.off();E(this,a,c,c!==q.location.href,g);a.preventDefault();return!1});c.form&&jQuery(this).undelegate(c.form,c.nss.submit).delegate(c.form,c.nss.submit,c.id,function(a){a.timeStamp=(new Date).getTime();var b,c,g;b=n[a.data];c=this.action;b.cache[a.type.toLowerCase()]&&(g=w(b.history,
c));b.landing&&(b.landing=!1);if(b.disable)return a.preventDefault(),!1;b.off();E(this,a,c,!0,g);a.preventDefault();return!1});jQuery(q).unbind(c.nss.popstate).bind(c.nss.popstate,c.id,function(a){a.timeStamp=(new Date).getTime();var b,c,g;b=n[a.data];c=q.location.href;b.cache[a.type.toLowerCase()]&&(g=w(b.history,c));if(b.landing){if(b.landing===q.location.href){b.landing=!1;return}b.landing=!1}if(b.disable)return a.preventDefault(),!1;b.off();E(this,a,c,!1,g);a.preventDefault();return!1});jQuery("script[src]").each(function(){this.src in
c.log.script||(c.log.script[this.src]=!0)})}s&&s.end();return{on:a.on,off:a.off}}if("undefined"!==typeof window.jQuery){jQuery=window.jQuery;var t=void 0,q=window,J=document,n=["settings"];jQuery.fn.pjax=u;jQuery.pjax=u;u=null}})();
