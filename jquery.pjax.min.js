...
n,v=n.responseText,s=k.textStatus||s,l=k.css,q=k.script,f.fire(m.cache.load.after,null,[g,h.parameter,k],h.callbacks.async));var x,t,u,w,y,z,B;z=h.area.split(/\s*,\s*/);t=(n.responseText||"").replace(/<noscript[^>]*>(?:.|[\n\r])*?<\/noscript>/gim,function(a){return a.replace(/<script(?:.|[\n\r])*?<\/script>/gim,"")});if(k&&k.data){w=k.data;u=a(f.parseHTML&&w&&f.parseHTML(w)||w);t=t.replace(/<title[^>]*?>([^<]*?)<\/title>/i,function(a){return f.find(w,/(<title[^>]*?>[^<]*?<\/title>)/i).shift()||a});
x=a(f.parseHTML&&t&&f.parseHTML(t)||t);for(var F=0,A,J;A=z[F++];)x.find(A).add(y?"":x.filter(A)).html(u.find(A).add(y?"":u.filter(A)).contents())}else x=a(f.parseHTML&&t&&f.parseHTML(t)||t);switch(!0){case !!x.find("html")[0]:y=1;x.find("noscript").each(function(){this.children.length&&a(this).text(this.innerHTML)});break;case !!x.filter("title")[0]:y=0;break;default:y=!1}switch(y){case 1:p=x.find("title").text();break;case 0:p=x.filter("title").text();break;case !1:p=a("<span/>").html(f.find(t,/<title[^>]*?>([^<]*?)<\/title>/i).shift()).text()}if(!a(h.area).length||
!x.find(h.area).add(y?"":x.filter(h.area)).length)throw Error("throw: area length mismatch");a(b).trigger(h.gns+".unload");!1!==f.fire(m.url.before,null,[g,h.parameter,v,s,n],h.callbacks.async)&&(r&&e!==h.location.href&&b.history.pushState(f.fire(h.state,null,[g,h.parameter,h.destination.href,h.location.href]),b.opera||-1!==b.navigator.userAgent.toLowerCase().indexOf("opera")?p:c.title,e),h.location.href=e,r&&h.fix.location&&(a[f.name].off(),b.history.back(),b.history.forward(),a[f.name].on()),f.fire(m.url.after,
...
for(F=0;A=z[F++];)J=x.find(A).add(y?"":x.filter(A)).clone().find("script").remove().end().contents(),a(A).html(J).append(B.clone());B=a(h.area).children("."+h.nss.class4html+"-check");a(c).trigger(h.gns+".DOMContentLoaded");f.fire(m.content.after,null,[g,h.parameter,v,s,n],h.callbacks.async)}var H=function(c){if(!1!==f.fire(m.scroll.before,null,[g,h.parameter],h.callbacks.async)){var d,e;switch(g.type.toLowerCase()){case "click":case "submit":d=c&&"function"===typeof h.scrollLeft?f.fire(h.scrollLeft,
...
null,[g,h.parameter],h.callbacks.async)}};H(!1);k&&k.XMLHttpRequest||!h.cache.click&&!h.cache.submit&&!h.cache.popstate||"submit"===g.type.toLowerCase()&&!h.cache[g.target.method.toLowerCase()]||!1===f.fire(m.cache.save.before,null,[g,h.parameter,k],h.callbacks.async)||(a[f.name].setCache(e,w||null,s,n),k=a[f.name].getCache(e),f.fire(m.cache.save.after,null,[g,h.parameter,k],h.callbacks.async));var I=function(b){if(!1!==f.fire(m.rendering.before,null,[g,h.parameter],h.callbacks.async)){var c=0;(function(){B.filter(function(){return this.clientWidth||
this.clientHeight||a(this).is(":hidden")}).length===B.length||100<=c?C(b):B.length&&(c++,setTimeout(arguments.callee,h.interval))})()}},C=function(c){B.remove();h.scroll.record=!0;f.hashscroll("popstate"===g.type.toLowerCase())||H(!0);a(b).trigger(h.gns+".load");f.fire(c);f.fire(m.rendering.after,null,[g,h.parameter],h.callbacks.async)};switch(y){case 1:case 0:x.find("noscript").remove();break;case !1:t=t.replace(/^(?:.|[\n\r])*<body[^>]*>.*[\n\r]*.*[\n\r]*/im,function(a){return a.replace(/\x3c!--\[(?:.|[\n\r])*?<!\[endif\]--\x3e/gim,
"")}),t=t.replace(/<noscript(?:.|[\n\r])*?<\/noscript>/gim,"")}var G=function(c){if(h.load.script&&!1!==f.fire(m.script.before,null,[g,h.parameter,v,s,n],h.callbacks.async)){var d;d=(k=a[f.name].getCache(e))&&!k.script;switch(q||y){case 1:case 0:q=x.find("script").add(y?"":x.filter("script")).clone().get();break;case !1:q=f.find(t,/(?:[^\'\"]|^\s*?)(<script[^>]*?>(?:.|[\n\r])*?<\/script>)(?:[^\'\"]|\s*?$)/gim)}q=a(q).not(h.load.reject);k&&k.script&&q&&q.length!==k.script.length&&(d=!0);d&&(k.script=
...
b.eval.call(b,(l.text||l.textContent||l.innerHTML||"").replace(/^\s*<!(?:\[CDATA\[|\-\-)/,"/*$0*/"))}catch(w){break}}f.fire(m.script.after,null,[g,h.parameter,v,s,n],h.callbacks.async)}};if(!1!==f.fire(m.verify.before,null,[g,h.parameter],h.callbacks.async)){if(e===f.canonicalizeURL(b.location.href))h.retry=!0;else if(h.retry)h.retry=!1,f.drive(a,b,c,d,f,h,g,b.location.href,!1,h.cache[g.type.toLowerCase()]&&a[f.name].getCache(f.canonicalizeURL(b.location.href)));else throw Error("throw: location mismatch");
f.fire(m.verify.after,null,[g,h.parameter],h.callbacks.async)}(function(){if(h.load.css&&!1!==f.fire(m.css.before,null,[g,h.parameter,v,s,n],h.callbacks.async)){var b,c=[],d=a('link[rel~="stylesheet"], style');b=(k=a[f.name].getCache(e))&&!k.css;switch(l||y){case 1:case 0:l=x.find('link[rel~="stylesheet"], style').add(y?"":x.filter('link[rel~="stylesheet"], style')).clone().get();break;case !1:l=f.find(t,/(<link[^>]*?rel=.[^"\']*?stylesheet[^>]*?>|<style[^>]*?>(?:.|[\n\r])*?<\/style>)/gim)}l=a(l).not(h.load.reject);
d=d.not(h.load.reload);k&&k.css&&l&&l.length!==k.css.length&&(b=!0);b&&(k.css=[]);for(var p=0,q,r;q=l[p];p++){q="object"===typeof q?b?a(q.outerHTML)[0]:q:a(q)[0];q="function"===typeof h.load.rewrite?f.fire(h.load.rewrite,null,[q.cloneNode()])||q:q;b&&(k.css[p]=q);r=f.trim(q.href||q.innerHTML||"");for(var w=0,u;u=d[w];w++)if(!c.length&&f.trim(u.href||u.innerHTML||"")===r){d=d.not(u);q=null;break}else if(!w&&c.length)break;q&&c.push(q)}d.remove();a("head").append(c);f.fire(m.css.after,null,[g,h.parameter,
v,s,n],h.callbacks.async)}})();a(c).trigger(h.gns+".ready");a(b).bind(h.gns+".rendering",function(b){a(b.target).unbind(b.type+".rendering",arguments.callee);G(":not([defer]), :not([src])");h.load.sync?I(function(){G("[src][defer]")}):(I(),G("[src][defer]"))}).trigger(h.gns+".rendering");if(!1===f.fire(m.success,null,[g,h.parameter,v,s,n],h.callbacks.async))break a;if(!1===f.fire(m.complete,null,[g,h.parameter,v,s,n],h.callbacks.async))break a;if(!1===f.fire(h.callback,null,[g,h.parameter,v,s,n],
h.callbacks.async))break a}catch(L){k&&a[f.name].removeCache(e);if(!1===f.fire(m.error,null,[g,h.parameter,v,s,n],h.callbacks.async))break a;if(!1===f.fire(m.complete,null,[g,h.parameter,v,s,n],h.callbacks.async))break a;if(h.fallback)return"function"===typeof h.fallback?f.fire(h.fallback,null,[g,h.parameter,h.destination.href,h.location.href]):f.fallback(g)}f.fire(m.after,null,[g,h.parameter,v,s,n],h.callbacks.async)}}}b.scroll.record=!1;b.fix.reset&&/click|submit/.test(k.type.toLowerCase())&&c.scrollTo(a(c).scrollLeft(),
0);if(!1!==d.fire(b.callbacks.before,null,[k,b.parameter],b.callbacks.async))if(l&&l.XMLHttpRequest)a.when?a.when(d.wait(d.fire(b.wait,null,[k,b.parameter,b.destination.href,b.location.href]))).done(function(){q(a,c,f,g,d,b,k,l)}):q(a,c,f,g,d,b,k,l);else if(b.xhr&&b.xhr.promise){var t=b.wait&&isFinite(b.xhr.timeStamp)?Math.max(b.wait-(new Date).getTime()+b.xhr.timeStamp,0):0;a.when(b.xhr,d.wait(t)).done(function(){q(a,c,f,g,d,b,k,a[d.name].getCache(e))})}else{var w,v,n,s,u,t={};switch(k.type.toLowerCase()){case "click":t.type=
"GET";break;case "submit":t.type=k.target.method.toUpperCase();"POST"===t.type&&(t.data=a(k.target).serializeArray());break;case "popstate":t.type="GET"}w=a.when?a.Deferred():null;a.extend(!0,t,b.ajax,{xhr:b.callbacks.ajax.xhr?function(){n=d.fire(b.callbacks.ajax.xhr,null,[k,b.parameter],b.callbacks.async);return n="object"===typeof n&&n||a.ajaxSettings.xhr()}:g,beforeSend:function(a,c){n=a;b.xhr&&4>b.xhr.readyState&&b.xhr.abort();b.xhr=n;n.setRequestHeader(b.nss.requestHeader,"true");n.setRequestHeader(b.nss.requestHeader+
"-Area",b.area);n.setRequestHeader(b.nss.requestHeader+"-CSS",b.load.css);n.setRequestHeader(b.nss.requestHeader+"-Script",b.load.script);d.fire(b.callbacks.ajax.beforeSend,null,[k,b.parameter,n,c],b.callbacks.async)},dataFilter:b.callbacks.ajax.dataFilter?function(a,c){v=a;return d.fire(b.callbacks.ajax.dataFilter,null,[k,b.parameter,v,c],b.callbacks.async)||v}:g,success:function(a,c,f){v=a;s=c;n=f;d.fire(b.callbacks.ajax.success,null,[k,b.parameter,v,s,n],b.callbacks.async)},error:function(a,c,
f){n=a;s=c;u=f;d.fire(b.callbacks.ajax.error,null,[k,b.parameter,n,s,u],b.callbacks.async)},complete:function(e,r){n=e;s=r;d.fire(b.callbacks.ajax.complete,null,[k,b.parameter,n,s],b.callbacks.async);if(u){if(w&&w.reject(),b.fallback&&"abort"!==s)return"function"===typeof b.fallback?d.fire(b.fallback,null,[k,b.parameter,b.destination.href,b.location.href]):d.fallback(k)}else w&&w.resolve()||q(a,c,f,g,d,b,k,l)}});t.url=e.replace(/([^#]+)(#[^\s]*)?$/,"$1"+(b.server.query?(e.match(/\?/)?"&":"?")+encodeURIComponent(b.server.query):
"")+"$2");a.when&&a.when(w.promise(),d.wait(d.fire(b.wait,null,[k,b.parameter,b.destination.href,b.location.href]))).done(function(){q(a,c,f,g,d,b,k,l)});a.ajax(t);d.fire(b.callbacks.after,null,[k,b.parameter],b.callbacks.async)}},canonicalizeURL:function(a){var c;c=g.trim(a);c=c.replace(/[<>"{}|\\^\[\]`\s].*/,"");c=/^https?:/i.test(c)?c:k("<a/>",{href:c})[0].href;c=encodeURI(decodeURI(c));return c=c.replace(/(?:%\w{2})+/g,function(c){return a.match(c.toLowerCase())||c})},trim:function(a){if(String.prototype.trim)a=
String(a).trim();else if(a=String(a).replace(/^\s+/,""))for(var c=a.length;--c;)if(/\S/.test(a.charAt(c))){a=a.substring(0,c+1);break}return a},fire:function(a,c,f,g){return"function"===typeof a?g?setTimeout(function(){a.apply(c,f)},0):a.apply(c,f):a},hashscroll:function(a){var c=g.settings[1].destination.hash.slice(1);return!(a||!c)&&k("#"+(c?c:", [name~="+c+"]")).first().each(function(){isFinite(k(this).offset().top)&&r.scrollTo(k(r).scrollLeft(),parseInt(Number(k(this).offset().top),10))}).length},
wait:function(a){var c=k.Deferred();if(!a)return c.resolve();setTimeout(function(){c.resolve()},a);return c.promise()},fallback:function(a){switch(a.type.toLowerCase()){case "click":r.location.href=a.currentTarget.href;break;case "submit":a.target.submit();break;case "popstate":r.location.reload()}},find:function(a,c){var f=[];a.replace(c,function(a,c){f.push(c)});return f},scope:function(a,c,f,p){var d,b,m,e,r,l,q,t,w,v,n,s,z;d=[].slice.call(arguments);d.splice(1,1,c||a.location.href);d.splice(2,
1,f||a.destination.href);b=a.scope;c=(c||a.location.href).replace(/.+?\w(\/[^#?]*).*/,"$1");f=(f||a.destination.href).replace(/.+?\w(\/[^#?]*).*/,"$1");m=c.replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");r=(p||c).replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");if(p){if(-1===p.indexOf("*"))return u;e=[];for(var D=r.length;D--;)"*"===r[D]&&e.unshift(m[D])}for(D=r.length+1;D--;)if(w=v=n=s=u,m=r.slice(0,D).join("/").replace(/\/([?#])/g,"$1"),(m="/"+m+("/"===(p||c).charAt(m.length+1)?"/":""))&&
m in b){if(!b[m]||!b[m].length)return!1;for(var C=0;(l=b[m][C])&&!1!==n&&!1!==s;C++)if("rewrite"!==l||"function"!==typeof b.rewrite||p)if("inherit"===l)v=!0;else if("string"===typeof l){l=(q="^"===l.charAt(0))?l.slice(1):l;l=(t="*"===l.charAt(0))?l.slice(1):l;if(p&&-1!==l.indexOf("/*/"))for(var E=0,K=e.length;E<K;E++)l=l.replace("/*/","/"+e[E]+"/");if(!(!q&&n||(t?c.search(l):c.indexOf(l)))){if(q)return!1;n=!0}if(!(!q&&s||(t?f.search(l):f.indexOf(l)))){if(q)return!1;s=!0}}else"object"===typeof l&&
(z=l);else if(d.push(g.fire(b.rewrite,null,[f])),w=arguments.callee.apply(this,d)){n=s=!0;break}else if(!1===w)return!1;if(n&&s)return k.extend(!0,{},a,("object"===typeof w?w:z)||{});if(!v)break}},database:function(a){var c=g.settings[1],f,p,d,b,m,e;f=c.gns;p=1;d=Math.floor(c.timestamp/864E5);b=g.IDBFactory;m=g.IDBDatabase;a=a||0;c.database=!1;if(!b||!f||5<a)return!1;try{var u=function(c){g.IDBDatabase=null;m&&m.close&&m.close();b.deleteDatabase(f);c?setTimeout(function(){g.database(++a)},c):g.database(++a)};
p=parseInt(d-d%7+p,10);m=b.open(f);m.onblocked=function(){};m.onupgradeneeded=function(){var a=this.result;try{for(var b=a.objectStoreNames?a.objectStoreNames.length:0;b--;)a.deleteObjectStore(a.objectStoreNames[b]);a.createObjectStore(c.gns,{keyPath:"id",autoIncrement:!1}).createIndex("date","date",{unique:!1})}catch(d){}};m.onsuccess=function(){try{m=this.result,g.IDBDatabase=m,(e=g.dbStore())?e.get("_version").onsuccess=function(){this.result&&p!==this.result.title?u():(g.dbVersion(p),g.dbCurrent(),
g.dbTitle(c.location.href,z.title),g.dbScroll(k(r).scrollLeft(),k(r).scrollTop()),c.database=!0)}:u()}catch(a){u(1E3)}};m.onerror=function(a){u(1E3)}}catch(l){u(1E3)}},dbStore:function(){for(var a=g.settings[1],c=g.IDBDatabase,f=c&&c.objectStoreNames?c.objectStoreNames.length:0;f--;)if(a.gns===c.objectStoreNames[f])return c&&c.transaction&&c.transaction(a.gns,"readwrite").objectStore(a.gns);return!1},dbCurrent:function(){var a=g.settings[1],c=g.dbStore();if(c){var f;f=g.canonicalizeURL(r.location.href);
