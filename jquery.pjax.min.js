 ...
 */
(function(){function z(t){function z(a,b){b.id=1;p[b.id]=b;b.link&&jQuery(a).undelegate(b.link,b.nss.click).delegate(b.link,b.nss.click,b.id,function(a){a.timeStamp=(new Date).getTime();if(1<a.which||(a.metaKey||a.ctrlKey||a.shiftKey||a.altKey)||(e.location.protocol!==this.protocol||e.location.host!==this.host)||e.location.pathname===this.pathname&&e.location.search===this.search&&e.location.hash!==this.hash)return this;var b,g,n;b=p[a.data];g=this.href;b.area=k(b.options.area,null,[a])||b.options.area;
b.landing&&(b.landing=!1);if(!b.disable&&jQuery(b.area).length)return b.off(),b.cache[a.type.toLowerCase()]&&(n=w(b.history,g)),D(this,a,g,g!==e.location.href,n),a.preventDefault(),!1});b.form&&jQuery(a).undelegate(b.form,b.nss.submit).delegate(b.form,b.nss.submit,b.id,function(a){a.timeStamp=(new Date).getTime();var b,g,n;b=p[a.data];g=this.action;b.area=k(b.options.area,null,[a])||b.options.area;b.landing&&(b.landing=!1);if(!b.disable&&jQuery(b.area).length)return b.off(),b.cache[a.type.toLowerCase()]&&
(n=w(b.history,g)),D(this,a,g,!0,n),a.preventDefault(),!1});jQuery(e).unbind(b.nss.popstate).bind(b.nss.popstate,b.id,function(a){a.timeStamp=(new Date).getTime();var b,g,n;b=p[a.data];g=e.location.href;b.area=k(b.options.area,null,[a])||b.options.area;if(b.landing){if(b.landing===e.location.href){b.landing=!1;return}b.landing=!1}if(!b.disable&&jQuery(b.area).length)return b.off(),b.cache[a.type.toLowerCase()]&&(n=w(b.history,g)),D(this,a,g,!1,n),a.preventDefault(),!1});jQuery("script[src]").each(function(){this.src in
b.log.script||(b.log.script[this.src]=!0)})}function D(g,b,q,I,f){function s(){jQuery.when(H(a.wait),jQuery.ajax(jQuery.extend(!0,{},a.ajax,y,{url:a.ajax.url,beforeSend:function(c){h=c;h.setRequestHeader(a.nss.requestHeader,"true");h.setRequestHeader(a.nss.requestHeader+"-Area",a.area);h.setRequestHeader(a.nss.requestHeader+"-CSS",a.load.css);h.setRequestHeader(a.nss.requestHeader+"-Script",a.load.script);k(a.callbacks.ajax.beforeSend,g,[b,a.parameter,h],a.callbacks.async)},success:function(c,d,q){l=
c;r=d;h=q;k(a.callbacks.ajax.success,g,[b,a.parameter,l,r,h],a.callbacks.async)},error:function(c,d,l){h=c;u=d;v=l;var m=p[a.id]&&p[a.id].validate?p[a.id].validate.clone({name:"jquery.pjax.js - drive()"}):m;m&&m.start();m&&m.test("++",1,[q,e.location.href],"ajax_regular()");m&&m.test("++",1,[h,u,v],"ajax error");k(a.callbacks.ajax.error,g,[b,a.parameter,h,u,v],a.callbacks.async);if(a.fallback)return"function"===typeof a.fallback?a.fallback(b):F(b,m);m&&m.end()}}))).done(function(){A()}).fail().always()}
function t(){jQuery.ajax(jQuery.extend(!0,{},a.ajax,y,{url:a.ajax.url,beforeSend:function(c){h=c;h.setRequestHeader(a.nss.requestHeader,"true");h.setRequestHeader(a.nss.requestHeader+"-Area",a.area);h.setRequestHeader(a.nss.requestHeader+"-CSS",a.load.css);h.setRequestHeader(a.nss.requestHeader+"-Script",a.load.script);k(a.callbacks.ajax.beforeSend,g,[b,a.parameter,h],a.callbacks.async)},success:function(c,d,q){l=c;r=d;h=q;k(a.callbacks.ajax.success,g,[b,a.parameter,l,r,h],a.callbacks.async);A()},
error:function(c,d,l){h=c;u=d;v=l;var m=p[a.id]&&p[a.id].validate?p[a.id].validate.clone({name:"jquery.pjax.js - drive()"}):m;m&&m.start();m&&m.test("++",1,[q,e.location.href],"ajax_legacy()");m&&m.test("++",1,[h,u,v],"ajax error");k(a.callbacks.ajax.error,g,[b,a.parameter,h,u,v],a.callbacks.async);if(a.fallback)return"function"===typeof a.fallback?a.fallback(b):F(b,m);m&&m.end()}}))}function A(c){var d=p[a.id]&&p[a.id].validate?p[a.id].validate.clone({name:"jquery.pjax.js - update()"}):d;d&&d.start();
d&&(d.scope=function(a){return eval(a)});d&&d.test("1",1,0,"update()");d&&d.test("++",1,0,"update:start");a:if(a.speedcheck&&a.log.speed.name.push("update_start"),a.speedcheck&&a.log.speed.time.push(a.speed.now()-a.log.speed.fire),!1!==k(a.callbacks.update.before,g,[b,a.parameter,l,r,h],a.callbacks.async)){var e=window,m=document,f,s,t;try{d&&d.test("++",1,0,"update:try");d&&d.test("++",1,c?0:[a.contentType,h.getResponseHeader("Content-Type")],"update:content-type");if(!c&&!RegExp(a.contentType.replace(/\s*[,;]\s*(.|$)/g,
...
jQuery.falsandtru[a];break;case e===n:f=a in jQuery.falsandtru?jQuery.falsandtru[a][b]:n;break;case e!==n:jQuery.falsandtru[a]instanceof Object||(jQuery.falsandtru[a]={}),jQuery.falsandtru[a][b]instanceof Object&&e instanceof Object?jQuery.extend(!0,jQuery.falsandtru[a][b],e):jQuery.falsandtru[a][b]=e,f=jQuery.falsandtru[a][b]}return f}if("function"===typeof this)return arguments.callee.apply(jQuery(J),arguments);var f=window.validator instanceof Object?window.validator:!1;(f=f?f.clone({name:"jquery.pjax.js",
base:!0,timeout:{limit:t&&t.ajax&&t.ajax.timeout?t.ajax.timeout+f.timeout.limit:f.timeout.limit}}):f)&&f.start();f&&f.test("++",1,0,"pjax()");var a=jQuery.extend(!0,{},{id:0,gns:"pjax",ns:n,area:n,link:'a:not([target])[href^="/"]',form:n,scrollTop:0,scrollLeft:0,ajax:{},contentType:"text/html",cache:{click:!1,submit:!1,popstate:!1,length:9,size:1048576,expire:18E5},callback:function(){},callbacks:{ajax:{},update:{url:{},title:{},content:{},css:{},script:{},cache:{load:{},save:{}},rendering:{},verify:{}},
async:!1},parameter:n,load:{css:!1,script:!1,execute:!0,sync:!0,async:0},interval:300,wait:0,fallback:!0,server:{},speedcheck:!1},t),s=[a.gns];jQuery.extend(!0,a,{nss:{pjax:s.join("."),click:["click"].concat(s.join(":")).join("."),submit:["submit"].concat(s.join(":")).join("."),popstate:["popstate"].concat(s.join(":")).join("."),data:s.join(":"),class4html:s.join("-"),requestHeader:["X",s[0].replace(/^\w/,function(a){return a.toUpperCase()})].join("-"),array:s},server:{query:a.server.query===n?a.gns:
a.server.query},log:{script:{},speed:{}},history:{config:a.cache,order:[],data:{}},timestamp:(new Date).getTime(),disable:!1,on:function(){for(var a=1,b=p.length;a<b;a++)p[a].disable=!1},off:function(){for(var a=1,b=p.length;a<b;a++)p[a].disable=!0},landing:e.location.href,validate:f,retry:!0,speed:{now:function(){return(new Date).getTime()}},options:t});jQuery.falsandtru||(jQuery.fn.falsandtru=C,jQuery.falsandtru=C);jQuery.falsandtru("share","history",a.history);a.history=jQuery.falsandtru("share",
"history");"pushState"in e.history&&null!==e.history.pushState&&z(this,a);f&&f.end();return{on:a.on,off:a.off}}if("undefined"!==typeof window.jQuery){jQuery=window.jQuery;var n=void 0,e=window,J=document,p=["settings"];jQuery.fn.pjax=z;jQuery.pjax=z;z=null}})();
