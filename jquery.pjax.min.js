...
(h=C(b)),J(c,a,b,!0,h),a.preventDefault()}});d(a).undelegate(b.form,b.nss.submit).delegate(b.form,b.nss.submit,b.id,H=function(a){a.timeStamp=(new Date).getTime();var c=E[1];if(c.disable)return a.preventDefault();c.destination.href=A(this.action);if(!(1<a.which||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey)){var b,h;b=c.destination.href=A(c.destination.href.replace(/[?#].*/,"")+("GET"===a.target.method.toUpperCase()?"?"+d(a.target).serialize():""));c.area=n(c.options.area,null,[a,b]);c.timestamp=a.timeStamp;
c.landing&&(c.landing=!1);if(d(c.area).length&&(!c.scope||F(c)))return c.cache[a.type.toLowerCase()]&&c.cache[a.target.method.toLowerCase()]&&(h=C(b)),J(c,a,b,!0,h),a.preventDefault()}});d(m).unbind(b.nss.popstate).bind(b.nss.popstate,b.id,function(a){a.timeStamp=(new Date).getTime();var c=E[1];if(c.disable)return a.preventDefault();c.destination.href=A(m.location.href);if(c.location.href===c.destination.href)return a.preventDefault();var b,h;if(!n(c.hashquery,null,[a,b])&&c.location.pathname+c.location.search===
c.destination.pathname+c.destination.search)return a.preventDefault();b=c.destination.href;c.area=n(c.options.area,null,[a,b]);c.timestamp=a.timeStamp;if(c.landing){if(c.landing.href===b){c.landing=!1;return}c.landing=!1}if(d(c.area).length)return c.database&&c.fix.history&&O(b),c.cache[a.type.toLowerCase()]&&(h=C(b)),J(c,a,b,!1,h),a.preventDefault()});b.database&&b.fix.scroll&&d(m).unbind(b.nss.scroll).bind(b.nss.scroll,b.id,function(a,c){var b=E[1],h,n=arguments.callee;if(b.scroll.delay){for(;h=
