...
typeof d.cache.expires&&"number"===typeof d.cache.expires.max?Math.min(d.cache.expires.max,r):r;r="object"===typeof d.cache.expires&&"number"===typeof d.cache.expires.min?Math.max(d.cache.expires.min,r):r;t=z+r}e.size=e.size||0;e.size+=e.data[a]?0:u;e.data[a]=m.extend(!0,e.data[a]||{},{XMLHttpRequest:f,textStatus:b,data:c,size:u,expires:t||0,timeStamp:z});d.database&&d.fix.history&&k.dbTitle(a,h)}return this},h.getCache=function(a){var c=k.settings[1];if(!c||!c.history)return!1;var b;b=c.history;
...
e=e.not(g.load.reject).not(g.load.reload);k&&k.css&&l&&l.length!==k.css.length&&(b=!0);b&&(k.css=[]);for(var m=0,p,u;p=l[m];m++){p="object"===typeof p?b?a(p.outerHTML)[0]:p:a(p)[0];p="function"===typeof g.load.rewrite?f.fire(g.load.rewrite,null,[p.cloneNode()])||p:p;b&&(k.css[m]=p);u=f.trim(p.href||p.innerHTML||"");for(var w=0,v;v=e[w];w++)if(!c.length&&f.trim(v.href||v.innerHTML||"")===u){e=e.not(v);p=null;break}else if(!w&&c.length)break;p&&c.push(p)}e.remove();a("head").append(c);f.fire(n.css.after,
null,[h,g.parameter,r,s,q],g.callbacks.async)}})();a(b).one(g.gns+".rendering",function(b){b.preventDefault();b.stopImmediatePropagation();K(!1);a(c).trigger(g.gns+".ready");H(":not([defer]), :not([src])");g.load.sync?L(function(){H("[src][defer]")}):(L(),H("[src][defer]"))}).trigger(g.gns+".rendering");if(!1===f.fire(n.success,null,[h,g.parameter,r,s,q],g.callbacks.async))break a;if(!1===f.fire(n.complete,null,[h,g.parameter,r,s,q],g.callbacks.async))break a;if(!1===f.fire(g.callback,null,[h,g.parameter,
...
e){var h=[];a.replace(e,function(a,c){h.push(c)});return h},scope:function(a,e,h,l){var c,b,f,d,E,n,u,z,t,r,q,s,y;c=[].slice.call(arguments);c.splice(1,1,e||a.location.href);c.splice(2,1,h||a.destination.href);b=a.scope;e=(e||a.location.href).replace(/.+?\w(\/[^#?]*).*/,"$1");h=(h||a.destination.href).replace(/.+?\w(\/[^#?]*).*/,"$1");f=e.replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");E=(l||e).replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");if(l){if(!~l.indexOf("*"))return v;d=[];for(var w=
0,C=E.length;w<C;w++)"*"===E[w]&&d.push(f[w])}for(w=E.length+1;w--;)if(t=r=q=s=v,f=E.slice(0,w).join("/").replace(/\/([?#])/g,"$1"),(f="/"+f+("/"===(l||e).charAt(f.length+1)?"/":""))&&f in b){if(!b[f]||!b[f].length)return!1;for(var I=0;(n=b[f][I])&&!1!==q&&!1!==s;I++)if("rewrite"!==n||"function"!==typeof b.rewrite||l)if("inherit"===n)r=!0;else if("string"===typeof n){n=(u="^"===n.charAt(0))?n.slice(1):n;n=(z="*"===n.charAt(0))?n.slice(1):n;if(l&&~n.indexOf("/*/"))for(var G=0,C=d.length;G<C;G++)n=
n.replace("/*/","/"+d[G]+"/");if(!(!u&&q||(z?e.search(n):e.indexOf(n)))){if(u)return!1;q=!0}if(!(!u&&s||(z?h.search(n):h.indexOf(n)))){if(u)return!1;s=!0}}else"object"===typeof n&&(y=n);else if(c.push(k.fire(b.rewrite,null,[h])),t=arguments.callee.apply(this,c)){q=s=!0;break}else if(!1===t)return!1;if(q&&s)return m.extend(!0,{},a,("object"===typeof t?t:y)||{});if(!r)break}},database:function(a){var e=k.settings[1],h,p,c,b,f,d;h=e.gns;p=1;c=Math.floor((new Date).getTime()/864E5);b=k.IDBFactory;f=k.IDBDatabase;
a=a||0;e.database=!1;if(!b||!h||5<a)return!1;try{var v=function(c){k.IDBDatabase=null;f&&f.close&&f.close();b.deleteDatabase(h);c?setTimeout(function(){k.database(++a)},c):k.database(++a)};p=parseInt(c-c%7+p,10);f=b.open(h);f.onblocked=function(){};f.onupgradeneeded=function(){var a=this.result;try{for(var b=a.objectStoreNames?a.objectStoreNames.length:0;b--;)a.deleteObjectStore(a.objectStoreNames[b]);a.createObjectStore(e.gns,{keyPath:"id",autoIncrement:!1}).createIndex("date","date",{unique:!1})}catch(c){}};
f.onsuccess=function(){try{f=this.result,k.IDBDatabase=f,(d=k.dbStore())?d.get("_version").onsuccess=function(){this.result&&p!==this.result.title?v():(k.dbVersion(p),k.dbCurrent(),k.dbTitle(e.location.href,y.title),k.dbScroll(m(l).scrollLeft(),m(l).scrollTop()),e.database=!0)}:v()}catch(a){v(1E3)}};f.onerror=function(a){v(1E3)}}catch(n){v(1E3)}},dbStore:function(){for(var a=k.settings[1],e=k.IDBDatabase,h=e&&e.objectStoreNames?e.objectStoreNames.length:0;h--;)if(a.gns===e.objectStoreNames[h])return e&&
