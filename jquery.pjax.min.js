...
c.location.href,f);a.preventDefault();return!1});f.form&&jQuery(this).undelegate(f.form,f.nss.submit).delegate(f.form,f.nss.submit,f.id,function(a){a.timeStamp=(new Date).getTime();var b,c,f;b=r[a.data];c=jQuery.prop?jQuery(a.target).prop("action"):jQuery("<a/>",{href:jQuery(a.target).attr("action")})[0].href;b.cache[a.type.toLowerCase()]&&(f=w(b.history,c));b.landing&&(b.landing=!1);if(b.disable)return a.preventDefault(),!1;b.off();t(this,a,c,!0,f);a.preventDefault();return!1});jQuery(c).unbind(f.nss.popstate).bind(f.nss.popstate,
f.id,function(a){a.timeStamp=(new Date).getTime();var b,e,f;b=r[a.data];e=c.location.href;b.cache[a.type.toLowerCase()]&&(f=w(b.history,e));if(b.landing){if(b.landing===c.location.href){b.landing=!1;return}b.landing=!1}if(b.disable)return a.preventDefault(),!1;b.off();t(this,a,e,!1,f);a.preventDefault();return!1});jQuery("script[src]").each(function(){this.src in f.log.script||(f.log.script[this.src]=!0)})}s&&s.end();return{on:a.on,off:a.off}}if("undefined"!==typeof window.jQuery){jQuery=window.jQuery;
var u=void 0,c=window,E=document,r=["settings"];jQuery.fn.pjax=t;jQuery.pjax=t;t=null}})();
