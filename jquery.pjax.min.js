...
k(a.callbacks.update.content.after,h,[b,a.parameter,l,j,d])}a.load.css&&setTimeout(function(){if(!1!==k(a.callbacks.update.css.before,h,[b,a.parameter,l,j,d])){m=m?m:s?n.find('link[rel="stylesheet"], style').add(n.filter('link[rel="stylesheet"], style')):B(l,'(<link[^>]*?rel="stylesheet"[^>]*?>|<style[^>]*?>(.|[\n\r])*?</style>)');u(a.history,f)&&(u(a.history,f).css=m);jQuery('link[rel="stylesheet"], style').filter(function(){return jQuery.data(this,a.nss.data,!0)});for(var g=0,c,q=jQuery('link[rel="stylesheet"]'),
e=jQuery("style"),w;c=m[g];g++){w=!1;c=s?c:jQuery(c)[0];if("LINK"===c.tagName.toUpperCase()&&q.filter(function(){if(w||this.href!==c.href)return!1;w=!0;jQuery.data(this,a.nss.data)&&jQuery.data(this,a.nss.data,!1);return!0}).length)continue;if("STYLE"===c.tagName.toUpperCase()&&e.filter(function(){if(w||!jQuery.data(this,a.nss.data)||this.innerHTML!==c.innerHTML)return!1;w=!0;jQuery.data(this,a.nss.data,!1);return!0}).length)continue;jQuery.data(jQuery("head").append(c).children(":last-child")[0],
...
h,[b,a.parameter,l,j])||l},complete:function(f,e){d=f;m=e;k(a.callbacks.ajax.complete,h,[b,a.parameter,d,m])}},v;for(v in x)v in a.callbacks.ajax||"xhr"===v||delete x[v];if("popstate"===b.type.toLowerCase()){if((F=f.match(/\?[^\s]*/))&&"?"!==F[0])a.ajax.type="GET";a.ajax.data=null}"submit"===b.type.toLowerCase()&&(f=f.replace(/\?[^\s]*/,""),a.ajax.type=jQuery(b.target).attr("method").toUpperCase(),"GET"===a.ajax.type&&(f+="?"+jQuery(b.target).serialize(),a.ajax.data=null),"POST"===a.ajax.type&&(a.ajax.data=
...
(k=u(b.history,c));b.landing&&(b.landing=!1);if(b.disable)return a.preventDefault(),!1;b.off();s(this,a,c,c!==g.location.href,k);a.preventDefault();return!1});c.form&&jQuery(this).undelegate(c.form,c.nss.submit).delegate(c.form,c.nss.submit,c.id,function(a){a.timeStamp=(new Date).getTime();var b,c,g;b=p[a.data];c=jQuery(a.target).attr("action");b.cache[a.type.toLowerCase()]&&(g=u(b.history,c));b.landing&&(b.landing=!1);if(b.disable)return a.preventDefault(),!1;b.off();s(this,a,c,!0,g);a.preventDefault();
return!1});jQuery(g).unbind(c.nss.popstate).bind(c.nss.popstate,c.id,function(a){a.timeStamp=(new Date).getTime();var b,c,k;b=p[a.data];c=g.location.href;b.cache[a.type.toLowerCase()]&&(k=u(b.history,c));if(b.landing){if(b.landing===g.location.href){b.landing=!1;return}b.landing=!1}if(b.disable)return a.preventDefault(),!1;b.off();s(this,a,c,!1,k);a.preventDefault();return!1});jQuery("script[src]").each(function(){this.src in c.log.script||(c.log.script[this.src]=!0)})}r&&r.end();return{on:a.on,off:a.off}}
