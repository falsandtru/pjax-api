...
b.scroll.queue.shift();)clearTimeout(h);h=setTimeout(function(){for(;h=b.scroll.queue.shift();)clearTimeout(h);K(d(m).scrollLeft(),d(m).scrollTop())},b.scroll.delay);b.scroll.queue.push(h)}else K(d(m).scrollLeft(),d(m).scrollTop());b.scroll.suspend&&!c&&(d(this).unbind(b.nss.scroll),setTimeout(function(){b.database&&b.fix.scroll&&d(m).bind(b.nss.scroll,b.id,n).trigger(b.nss.scroll,[!0])},b.scroll.suspend))})}function J(a,b,c,B,h){function l(a,b,e){var f=a.validate?a.validate.clone({name:"jquery.pjax.js - update()"}):
!1;f&&f.start();f&&(f.scope=function(a){return eval(a)});f&&f.test("1",1,0,"update()");f&&f.test("++",1,0,"start");a:{var h=a.speedcheck;h&&a.log.speed.name.push("update");h&&a.log.speed.time.push(a.speed.now()-a.log.speed.fire);var k=a.callbacks.update;if(!1!==n(k.before,null,[b,a.parameter,r,q,p],a.callbacks.async)){var l=window,u=document,m,g,v;try{f&&f.test("++",1,0,"try");f&&f.test("++",1,e?0:[a.contentType,p.getResponseHeader("Content-Type")],"content-type");if(!e&&-1===(p.getResponseHeader("Content-Type")||
"").toLowerCase().search(a.contentType))throw Error("throw: content-type mismatch");f&&f.test("++",e?"'usable'":"'unusable'",0,"cache");e&&!1!==n(k.cache.load.before,null,[b,a.parameter,e],a.callbacks.async)&&(p=e.XMLHttpRequest,r=p.responseText,q=e.textStatus,m=e.title,g=e.css,v=e.script,n(k.cache.load.after,null,[b,a.parameter,e],a.callbacks.async));f&&f.test("++",1,0,"initialize");var z,w,D,s;z=d(r);w=0<z.filter("title").length;D=a.area.replace(/(\((.*?(\(.*?\).*?)?)*?\)|\S)(,|$)/g,function(a,
b,c,f,e){return b+(e?"|":"")}).split(/\s*\|(?!=)\s*/);w||(r=r.replace(/^((?:.|[\n\r])*?<body[^>]*>.*[\n\r]*.*[\n\r]*)/im,"$1").replace(/\x3c!--\[(?:.|[\n\r])*?<!\[endif\]--\x3e/gim,""),r=r.replace(/<noscript(?:.|[\n\r])*?<\/noscript>/gim,""));m=m||w?z.filter("title").text():d("<span/>").html(P(r,/<title>([^<]*?)<\/title>/i).join()).text();if(!d(a.area).length||!z.find(a.area).add(z.filter(a.area)).length)throw Error("throw: area length mismatch");f&&f.test("++",1,c,"url");!1!==n(k.url.before,null,
[b,a.parameter,r,q,p],a.callbacks.async)&&(B&&c!==a.location.href&&l.history.pushState(n(a.state,null,[b,c]),l.opera||-1!==l.navigator.userAgent.toLowerCase().indexOf("opera")?m:u.title,c),a.location.href=c,B&&a.fix.location&&(I.off(),l.history.back(),l.history.forward(),I.on()),n(k.url.after,null,[b,a.parameter,r,q,p],a.callbacks.async));f&&f.test("++",1,m,"title");!1!==n(k.title.before,null,[b,a.parameter,r,q,p],a.callbacks.async)&&(u.title=m,a.database&&a.fix.history&&O(c,m),n(k.title.after,null,
[b,a.parameter,r,q,p],a.callbacks.async));a.database&&S();f&&f.test("++",1,0,"scroll");var y=function(c){var f,e;switch(b.type.toLowerCase()){case "click":case "submit":f=c&&"function"===typeof a.scrollLeft?n(a.scrollLeft,null,[b]):a.scrollLeft;f=0<=f?f:0;f=null===f?d(l).scrollLeft():parseInt(Number(f),10);e=c&&"function"===typeof a.scrollTop?n(a.scrollTop,null,[b]):a.scrollTop;e=0<=e?e:0;e=null===e?d(l).scrollTop():parseInt(Number(e),10);d(l).scrollTop()===e&&d(l).scrollLeft()===f||l.scrollTo(f,
e);c&&a.database&&a.fix.scroll&&K(f,e);break;case "popstate":c&&a.database&&a.fix.scroll&&K()}};y(!1);f&&f.test("++",1,D,"content");if(!1!==n(k.content.before,null,[b,a.parameter,r,q,p],a.callbacks.async)){d(a.area).children("."+a.nss.class4html+"-check").remove();s=d("<div/>",{"class":a.nss.class4html+"-check",style:"background: none !important; display: block !important; visibility: hidden !important; position: absolute !important; top: 0 !important; left: 0 !important; z-index: -9999 !important; width: auto !important; height: 0 !important; margin: 0 !important; padding: 0 !important; border: none !important; font-size: 12px !important; text-indent: 0 !important;"}).text(a.gns);
...
f&&h&&console.log(a.log.speed.time),"[src][defer]"===f&&h&&console.log(a.log.speed.name))}m&&m.end()};f&&f.test("++",1,0,"verify");if(!1!==n(k.verify.before,null,[b,a.parameter],a.callbacks.async)){if(c===A(l.location.href))a.retry=!0;else if(a.retry)a.retry=!1,J(a,b,l.location.href,!1,a.cache[b.type.toLowerCase()]&&C(A(l.location.href)));else throw Error("throw: location mismatch");n(k.verify.after,null,[b,a.parameter],a.callbacks.async)}(function(){var f=a.validate?a.validate.clone({name:"jquery.pjax.js - load_css()"}):
!1;f&&f.start();f&&(f.scope=function(a){return eval(a)});if(a.load.css&&!1!==n(k.css.before,null,[b,a.parameter,r,q,p],a.callbacks.async)){var l,m=[],u=d('link[rel~="stylesheet"], style');l=(e=C(c))&&!e.css;g=g?g:w?z.find('link[rel~="stylesheet"], style').add(z.filter('link[rel~="stylesheet"], style')).get():P(r,/(<link[^>]*?rel=.[^"\']*?stylesheet[^>]*?>|<style[^>]*?>(?:.|[\n\r])*?<\/style>)/gim);e&&e.css&&g&&g.length!==e.css.length&&(l=!0);l&&(e.css=[]);for(var B=0,t,v;t=g[B];B++){t="object"===
typeof t?t:d(t)[0];t="function"===typeof a.load.rewrite?n(a.load.rewrite,null,[t.cloneNode()])||t:t;l&&(e.css[B]=t);v=N(t.href||t.innerHTML||"");for(var s=0,D;D=u[s];s++)if(N(D.href||D.innerHTML||"")===v){u=u.not(D);t=null;break}t&&m.push(t)}u.remove();d("head").append(m);!1!==n(k.css.after,null,[b,a.parameter,r,q,p],a.callbacks.async)&&(h&&a.log.speed.name.push("css"),h&&a.log.speed.time.push(a.speed.now()-a.log.speed.fire))}f&&f.end()})();d(u).trigger(a.gns+".ready");d(l).bind(a.gns+".rendering",
function(b){d(b.target).unbind(b.type+".rendering",arguments.callee);G();F(":not([defer]), :not([src])");!a.load.sync&&F("[src][defer]");G(!0)}).trigger(a.gns+".rendering");if(!1===n(k.success,null,[b,a.parameter,r,q,p],a.callbacks.async))break a;if(!1===n(k.complete,null,[b,a.parameter,r,q,p],a.callbacks.async))break a;if(!1===n(a.callback,null,[b,a.parameter,r,q,p],a.callbacks.async))break a;f&&f.test("++",1,0,"success")}catch(Q){f&&f.test("++",!String(Q.message).indexOf("throw:"),Q,"catch");f&&
f.test("++",!("throw: location mismatch"===Q.message&&c!==l.location.href),[c,l.location.href],"!( err.message === 'throw: location mismatch' && url !== win.location.href )");e&&M(c);if(!1===n(k.error,null,[b,a.parameter,r,q,p],a.callbacks.async))break a;if(!1===n(k.complete,null,[b,a.parameter,r,q,p],a.callbacks.async))break a;f&&f.test("++",1,[c,l.location.href],"error");if(a.fallback)return"function"===typeof a.fallback?n(a.fallback,null,[b,c]):T(b,f)}!1!==n(k.after,null,[b,a.parameter,r,q,p],
...
e&&e.test("++",1,0,"start");a.scroll.record=!1;a.fix.reset&&/click|submit/.test(b.type.toLowerCase())&&m.scrollTo(d(m).scrollLeft(),0);if(!1!==n(a.callbacks.before,null,[b,a.parameter],a.callbacks.async))if(h)e&&e.test("++",1,0,"update"),d.when?d.when(U(a.wait)).done(function(){l(a,b,h)}):l(a,b,h),e&&e.test("++",1,0,"end"),e&&e.end();else{e&&e.test("++",1,0,"initialize");var k,g,r,p,q,v,x;k={};switch(b.type.toLowerCase()){case "click":e&&e.test("++",1,0,"event click");k.type="GET";break;case "submit":e&&
e.test("++",1,b.target.method,"event submit");k.type=b.target.method.toUpperCase();"POST"===k.type&&(k.data=d(b.target).serializeArray());break;case "popstate":e&&e.test("++",1,0,"event popstate"),k.type="GET"}g=d.when?d.Deferred():null;e&&e.test("++",1,0,"setting");d.extend(!0,k,a.ajax,{xhr:a.callbacks.ajax.xhr?function(){p=n(a.callbacks.ajax.xhr,null,[b,a.parameter],a.callbacks.async);return p="object"===typeof p&&p||d.ajaxSettings.xhr()}:w,beforeSend:function(c,e){p=c;a.xhr&&4>a.xhr.readyState&&
