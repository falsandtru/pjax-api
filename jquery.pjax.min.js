 ...
 */
(function(){function s(s){function q(j,c,b,h,a,m){function s(k){a:if(a.speed.check?a.speed.log.name.push("update_start"):null,a.speed.check?a.speed.log.time.push(a.speed.now()-a.speed.log.fire):null,!1!==e(a.callbacks.update.before,j,[c,a.parameter,g,l,f])){try{if(!k&&-1===f.getResponseHeader("Content-Type").indexOf("text/html"))throw Error();var w,x,m;!1!==e(a.callbacks.update.cache.before,j,[c,a.parameter,k])&&(k&&(f=k.XMLHttpRequest,g=f.responseText,l=k.dataType,w=k.title,x=k.css,m=k.script),e(a.callbacks.update.cache.after,
j,[c,a.parameter,k]));var t=jQuery(g),q=0<t.filter("title").length;w=w?w:q?t.filter("title").text():D(g,"<title>([^<]*)</title>");var v=a.area.split(","),y=null===a.scrollLeft?jQuery(u).scrollLeft():parseInt(a.scrollLeft),z=null===a.scrollTop?jQuery(u).scrollTop():parseInt(a.scrollTop);if(!jQuery(a.area).length||!t.find(a.area).add(t.filter(a.area)).length)throw Error();!1!==e(a.callbacks.update.url.before,j,[c,a.parameter,g,l,f])&&(b=b.replace(RegExp("[?&]"+a.server.query+"=.*?([sW#&]|$)"),""),h?
history.pushState(null,u.opera||"userAgent"in u&&-1!==userAgent.indexOf("opera")?w:E.title,b):null,e(a.callbacks.update.url.after,j,[c,a.parameter,g,l,f]));!1!==e(a.callbacks.update.title.before,j,[c,a.parameter,g,l,f])&&(E.title=w,e(a.callbacks.update.title.after,j,[c,a.parameter,g,l,f]));if(!1!==e(a.callbacks.update.content.before,j,[c,a.parameter,g,l,f])){for(var n=0,B;B=v[n];n++)jQuery(B).html(t.find(B).add(t.filter(B)).html()),a.load.script&&a.load.sync?jQuery(B).append(jQuery("<div/>",{"class":a.nss.class4html+
"-loaded",style:"display: block !important; visibility: hidden !important; width: auto !important; height: 0 !important; margin: 0 !important; padding: 0 !important; border: none !important; position: absolute !important; top: -9999px !important; left: -9999px !important; font-size: 12px !important; text-indent: 0 !important;"}).text("pjax")):null;e(a.callbacks.update.content.after,j,[c,a.parameter,g,l,f])}a.load.css?setTimeout(function(){if(!1!==e(a.callbacks.update.css.before,j,[c,a.parameter,g,
l,f])){x=x?x:q?t.find('link[rel="stylesheet"], style').add(t.filter('link[rel="stylesheet"], style')):D(g,'(<link[^>]*?rel="stylesheet"[^>]*?>|<style[^>]*?>(.|[\n\r])*?</style>)');jQuery('link[rel="stylesheet"], style').filter(function(){return jQuery.data(this,a.nss.data,!0)});for(var b=0,d,k;d=x[b];b++){k=!1;d=q?d:jQuery(d)[0];if("LINK"===d.tagName.toUpperCase()&&jQuery('link[rel="stylesheet"]').filter(function(){if(k||this.href!==d.href)return!1;k=!0;jQuery.data(this,a.nss.data)?jQuery.data(this,
a.nss.data,!1):null;return!0}).length)continue;if("STYLE"===d.tagName.toUpperCase()&&jQuery("style").filter(function(){if(k||!jQuery.data(this,a.nss.data)||this.innerHTML!==d.innerHTML)return!1;k=!0;jQuery.data(this,a.nss.data,!1);return!0}).length)continue;jQuery.data(jQuery("head").append(d).children(":last-child")[0],a.nss.data,!1);d=null}jQuery('link[rel="stylesheet"], style').filter(function(){return jQuery.data(this,a.nss.data)}).remove();!1!==e(a.callbacks.update.css.after,j,[c,a.parameter,
g,l,f])&&(a.speed.check?a.speed.log.name.push("css"):null,a.speed.check?a.speed.log.time.push(a.speed.now()-a.speed.log.fire):null)}},a.load.async||0):null;a.load.script?setTimeout(function(){A("async")},a.load.async||0):null;var A=function(b){if(!1!==e(a.callbacks.update.script.before,j,[c,a.parameter,g,l,f])){m=m?m:q?t.find("script").add(t.filter("script")):D(g,"(?:[^'\"]|^s*)(<script[^>]*?>(.|[\n\r])*?\x3c/script>)(?:[^'\"]|s*$)");for(var d=0,k,h;k=m[d];d++)if(h=!1,k=q?k:jQuery(k)[0],!a.load.sync||
"sync"!==b||k.defer)if((!a.load.sync||!("async"===b&&k.defer))&&!jQuery("script[src]").filter(function(){return h||this.src!==k.src?!1:h=!0}).length)jQuery.data(jQuery("head").append(k).children(":last-child")[0],a.nss.data,!1),k=null;e(a.callbacks.update.script.after,j,[c,a.parameter,g,l,f])}};a.load.script&&a.load.sync&&setTimeout(function(){jQuery(a.area).length===jQuery(a.area).children("."+a.nss.class4html+"-loaded").filter(function(){return this.clientWidth}).length?(jQuery(a.area).children("."+
a.nss.class4html+"-loaded").remove(),setTimeout(function(){A("sync")},0),a.speed.check?a.speed.log.name.push("script"):null,a.speed.check?a.speed.log.time.push(a.speed.now()-a.speed.log.fire):null,a.speed.check?console.log(a.speed.log.time):null,a.speed.check?console.log(a.speed.log.name):null,a.speed.check?console.log(a.speed.log.retry):null):(setTimeout(function(){arguments.callee()},a.interval),a.speed.check?++a.speed.log.retry:null)},0);h&&-1<"click,submit".indexOf(c.type.toLowerCase())?u.scrollTo(y,
z):null;if(a.cache[c.type.toLowerCase()]&&"POST"!==a.ajax.type){var d=a.history,C;d.order.unshift(b);for(var n=1,p;p=d.order[n];n++)b===p&&d.order.splice(n,1);if(!k){C=2*g.length;d.size+=C;d.data[b]={data:null,dataType:l,XMLHttpRequest:f,title:w,css:x,script:m,size:C,timestamp:(new Date).getTime()};n=d.order.length-1;for(C=d.size;p=d.order[n];n--)if(n>=a.cache.length||d.size>a.cache.size||c.timeStamp>d.data[p].timestamp+a.cache.expire)d.order.pop(),d.size-=d.data[p].size,d.data[p]=null,delete d.data[p];
a.history=d}}r[a.id]=a;if(!1===e(a.callbacks.update.success,j,[c,a.parameter,g,l,f]))break a;if(!1===e(a.callbacks.update.complete,j,[c,a.parameter,g,l,f]))break a;if(!1===e(a.callback,j,[c,a.parameter,g,l,f]))break a}catch(G){if(k){d=a.history;d.order.unshift(b);for(n=1;p=d.order[n];n++)b===p&&d.order.splice(n,1);n=d.order.length-1;for(C=d.size;p=d.order[n];n--)if(n>=a.cache.length||d.size>a.cache.size||c.timeStamp>d.data[p].timestamp+a.cache.expire)d.order.pop(),d.size-=d.data[p].size,d.data[p]=
null,delete d.data[p];a.history=d}r[a.id]=a;if(!1===e(a.callbacks.update.error,j,[c,a.parameter,g,l,f]))break a;if(!1===e(a.callbacks.update.complete,j,[c,a.parameter,g,l,f]))break a;a.fallback?F(c):null}!1!==e(a.callbacks.update.after,j,[c,a.parameter,g,l,f])&&(a.speed.check?a.speed.log.name.push("end"):null,a.speed.check?a.speed.log.time.push(a.speed.now()-a.speed.log.fire):null)}}a.speed.check?a.speed.log.fire=c.timeStamp:null;a.speed.check?a.speed.log.time=[]:null;a.speed.check?a.speed.log.name=
...
if(1<b.which||(b.metaKey||b.ctrlKey||b.shiftKey||b.altKey)||(location.protocol!==this.protocol||location.host!==this.host)||location.pathname===this.pathname&&location.search===this.search&&location.hash!==this.hash)return this;var c,e,h;c=r[b.data];e=this.href;c.cache[b.type.toLowerCase()]&&(h=c.history.data[e]);h&&b.timeStamp>h.timestamp+c.cache.expire&&(h=m);q(this,b,e,e!==location.href,r[b.data],h);b.preventDefault()}));b.form&&jQuery(this).undelegate(b.form,b.nss.submit).delegate(b.form,b.nss.submit,
b.id,function(b){b.timeStamp=(new Date).getTime();var c,e,h;c=r[b.data];e=jQuery(b.target).attr("action");c.cache[b.type.toLowerCase()]&&(h=c.history.data[e]);h&&b.timeStamp>h.timestamp+c.cache.expire&&(h=m);q(this,b,e,!0,r[b.data],h);b.preventDefault()});jQuery(u).unbind(b.nss.popstate).bind(b.nss.popstate,b.id,function(b){b.timeStamp=(new Date).getTime();var c,e,h;c=r[b.data];e=location.href;c.cache[b.type.toLowerCase()]&&(h=c.history.data[e]);h&&b.timeStamp>h.timestamp+c.cache.expire&&(h=m);!1!==
c.timestamp&&c.delay>b.timeStamp-c.timestamp?(c.timestamp=!1,r[c.id]=c):(q(this,b,e,!1,r[b.data],h),b.preventDefault())});return this}if("undefined"!==typeof window.jQuery){jQuery=window.jQuery;var m=void 0,u=window,E=document,r=["settings"];jQuery.fn.pjax=s;jQuery.pjax=s;s=null}})();
